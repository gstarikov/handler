...
### Examples
- [golang-graphql-playground](https://github.com/gstarikov/playground)
...
### Test
```bash
$ go get github.com/gstarikov/handler
$ go build && go test ./...
